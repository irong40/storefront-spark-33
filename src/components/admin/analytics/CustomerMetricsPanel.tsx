...
export function CustomerMetricsPanel() {
  const { data: customerStats, isLoading: customersLoading } = useCustomerStats('month');
  const { data: revenueStats, isLoading: revenueLoading } = useRevenueStats('month');
  ...
  const clv = customerStats.totalCustomers > 0 
