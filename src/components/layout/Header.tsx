        ...
        <div className="flex items-center gap-2">
          ...
          {isAdmin && (
            <Button
              ...
              size="icon"
              asChild
              className="rounded-full hover:bg-brand-cream-dark"
            >
              <Link to="/admin">
          ...
          <Button
            ...
            size="icon"
            asChild
            className="rounded-full hover:bg-brand-cream-dark hidden sm:flex"
          >
          ...
          {isAdmin ? (
            <Button
              asChild
              className="hidden md:inline-flex rounded-full px-6 bg-brand-olive hover:bg-brand-olive/90 shadow-sm font-semibold"
            >
            ...
            <Button
              asChild
              className="hidden md:inline-flex rounded-full px-6 bg-brand-berry hover:bg-brand-berry-dark shadow-berry font-semibold"
            >
          ...
          <Sheet open={isMobileOpen} onOpenChange={setIsMobileOpen}>
            <SheetTrigger asChild className="md:hidden">
              <button aria-label="Open navigation menu" className="flex flex-col gap-1.5 p-2">
                ...
                />
                <span
                  className={`block w-6 h-0.5 bg-brand-brown rounded-full transition-all ${isMobileOpen ? "opacity-0" : ""}`}
                />
                <span
                  className={`block w-6 h-0.5 bg-brand-brown rounded-full transition-all ${isMobileOpen ? "-rotate-45 -translate-y-2" : ""}`}
                />
            ...
            <SheetContent
              side="right"
              className="w-full bg-background p-8 pt-24"
            >
