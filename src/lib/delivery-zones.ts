// Hampton Roads / Tidewater Virginia delivery zone.
// Single source of truth — mirrored in supabase/functions/_shared/delivery-zones.ts
// for server-side validation. Update both when changing the list.
//
// Coverage:
//   South Hampton Roads: Portsmouth, Norfolk, Virginia Beach, Chesapeake, Suffolk
//   Peninsula:           Newport News, Hampton, Poquoson, Yorktown
//   Williamsburg area:   Williamsburg, James City County
//   Outlying:            Smithfield / Isle of Wight, Gloucester, Mathews
...
/**
 * Returns true if the given ZIP code falls inside the Hampton Roads /
 * Tidewater Virginia delivery zone. Accepts ZIP or ZIP+4.
 */
...
export const DELIVERY_ZONE_LABEL = "Hampton Roads / Tidewater Virginia";
