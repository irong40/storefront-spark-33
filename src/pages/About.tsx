...
const values = [
  {
    ...
    title: "All Natural",
    description:
      "All natural ingredients, sourced responsibly for purity and taste.",
  },
  {
    image: valueColdpressed,
    title: "Cold-Pressed",
    description:
      "Nutrient-rich extraction using hydraulic pressure, preserving vitamins and enzymes.",
  },
  {
    image: valueFresh,
    title: "Made Fresh Daily",
    description:
      "Small batches crafted every morning to ensure peak freshness and flavor.",
  },
  {
    image: valueCommunity,
    title: "Community First",
    description:
      "Committed to supporting local farms, partners, and fostering a healthy community.",
  },
  {
    image: valueEco,
    title: "Eco-Friendly",
    description:
      "Sustainable practices, from recyclable packaging to waste reduction initiatives.",
  },
  {
    image: valueQuality,
    title: "Quality Guaranteed",
    description:
      "Uncompromising standards, ensuring every bottle meets our rigorous quality criteria.",
  },
];
        ...
        <div className="container px-4">
          <div className="max-w-3xl mx-auto">
            <h2 className="text-3xl font-heading font-bold text-brand-brown text-center mb-12">
              <span className="font-script text-brand-terracotta">The</span>{" "}
              Cold-Press Difference
            </h2>
              ...
              {[
                {
                  ...
                  desc: "We work with local farms to source the freshest, highest-quality produce available.",
                },
                {
                  step: 2,
                  title: "Wash & Prep",
                  desc: "Every ingredient is thoroughly washed and carefully prepared by our trained team.",
                },
                {
                  step: 3,
                  title: "Cold Press",
                  desc: "Our hydraulic press applies thousands of pounds of pressure without heat, extracting maximum nutrients while preserving delicate enzymes.",
                },
                {
                  step: 4,
                  title: "Bottle Fresh",
                  desc: "Immediately bottled and refrigerated, our juices reach you at peak freshness. Best enjoyed within 3-5 days.",
                },
              ].map((item) => (
                <div key={item.step} className="flex gap-4">
                  ...
                  <div>
                    <h3 className="font-heading font-semibold text-lg text-brand-brown mb-2">
                      {item.title}
                    </h3>
      ...
      <section className="py-20 bg-brand-berry text-white">
        <div className="container px-4 text-center">
          ...
          <p className="text-white/80 text-lg max-w-2xl mx-auto mb-8">
            Join thousands of customers who have made fresh juice a daily
            ritual.
          </p>
          <Button
            asChild
            size="lg"
            className="bg-white text-brand-berry hover:bg-brand-cream"
          >
